...
function() {
    ...
    default, {
        ...
        default,
            escape: function(e) {
                return e && y.test(e) ? e.replace(g,
                function(e) {
                    return b[e]
                }) : e
            },
            unescape: function(e) {
                return e && v.test(e) ? e.replace(m,
                function(e) {
                    return w[e]
                }) : e
            },
    ...
    function(e, t, n) {
        ...
        y = n(4),
        m = y.call(Function.call, String.prototype.replace),
        v = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g,
        b = /\\(\\)?/g,
        w = function(e) {
            var t = [];
    ...
    function(e, t, n) {
        ...
        i = {
            ...
            maps: n(53),
            parse: function(e) {
                return String(e).replace(new RegExp(":(" + Object.keys(i.maps).join("|") + "):", "ig"),
                function(e, t) {
    ...
    function(e, t, n) {
        ...
        function c(e, t, n, r) {
            if (n = g(n), "href" === t || "src" === t) {
                ...
                if (M.lastIndex = 0, M.test(n) && (I.lastIndex = 0, I.test(n))) return ""; ! 1 !== r && (r = r || _, n = r.process(n))
            }
            return n = y(n)
        }
        function u(e) {
...
*/
    ...
    function(e, t, n) {
        ...
        i.prototype._init = function() {
            ...
            try {
                ...
                var u = P.ds,
                p = r ? "&q=" + h.RandomStr: "";
                P.params = "?d=" + (u.indexOf(n) > -1 ? n: "mp") + "&v=" + h.VERSION + p,
                P.hide = "hide" === n,
                P.cdn = /^https?\:\/\//.test(i) ? i: P.cdn,
                e.config.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l,
                c && (0, A.recordIPFn)(function(e) {
                    return E.ip = e
                });
            ...
            default)(f);
                ...
                default)(f),
                    ...
                    P.hide && e.$el.addClass("hide-avatar"),
            ...
            default)(e.config,
                ...
                default)(".valine-comment-count"),
                    ...
                    o && I.add(AV.Object.extend("Counter"), e.config.path),
                    e.$el && e.bind()
                })
            } catch(t) { (0, $.
            default)(e, t, "init")
        ...
        default.maps,
            ...
            e.$preview = {
                show: function() {
                    return j ? (e.$emoji.hide(), i.addClass("actived"), n.html(j).show(), M()) : e.$preview.hide(),
                    e.$preview
                },
                hide: function() {
            ...
            default)(t.val() || "");
                r || e.$preview.hide(),
                j != r && (j = r, i.hasClass("actived") > -1 && j != n.html() && n.html(j), (0, c.
            default)(t[0]), M())
            };
            r.on("click",
            function(t) {
            ...
            function() {
                ...
                default.store.remove(h.QQCacheKey), E.nick = n.val(), E.mail = "", E.QQAvatar = "") : (0, A.fetchQQFn)(n.val(),
                    function(e) {
                        var t = e.nick || n.val(),
                        r = e.qq + "@qq.com"; (0, v.
                    default)(".vnick").val(t),
            ...
            default.detect(o), a = '<span class="vsys">' + o.browser + " " + o.version + '</span> <span class="vsys">' + o.os + " " + o.osVersion + "</span>"),
                ...
                u = P.hide ? "": e.config.enableQQ && t.get("QQAvatar") ? '<img class="vimg" src="' + t.get("QQAvatar") + '" referrerPolicy="no-referrer"/>': '<img class="vimg" src="' + (P.cdn + (0, s.
            default)(t.get("mail")) + P.params) + '">',
                p = u + '<div class="vh"><div class="vhead">' + c + " " + a + '</div><div class="vmeta"><span class="vtime" >' + (0, y.
            ...
            M = function() {
                setTimeout(function() {
                    try {
                        ...
                        "renderMathInElement" in window && renderMathInElement((0, v.
                    default)(".v")[0], {
                            delimiters: [{
                                left: "$$",
                                right: "$$",
            ...
            z = function(t) {
                if (e.config.requiredFields.indexOf("nick") > -1 && E.nick.length < 3) return g.nick[0].focus(),
                void e.$el.find(".status-bar").text("" + e.i18n.t("nickFail")).empty(3e3);
                if (e.config.requiredFields.indexOf("mail") > -1 && !/[\w-\.]+@([\w-]+\.)+[a-z]{2,3}/.test(E.mail)) return g.mail[0].focus(),
            ...
            default.store.set("vlx", Date.now()),
                ...
                default.store.set(h.MetaCacheKey, {
                    ...
                    try {
                        I.rid ? T(t, (0, v.
                    default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), T(t, e.$el.find(".vcards")), k.skip++),
        ...
        default)(document).on("keydown",
            function(e) {
                e = event || e;
                var t = e.keyCode || e.which || e.charCode; ((e.ctrlKey || e.metaKey) && 13 === t && z(), 9 === t) && ("veditor" == (document.activeElement.id || "") && (e.preventDefault(), x(o[0], "    ")))
            }).on("paste",
            function(e) {
    ...
    default = function(e, t) {
        ...
        default.sdkLoader("//cdn.jsdelivr.net/npm/leancloud-storage@3/dist/av-min.js", "AV",
            function(n) {
                ...
                i = e.serverURLs || r + "avoscloud.com",
                AV.init({
                    appId: a,
                    appKey: s,
                    serverURLs: i
    ...
    default.setOptions({
            renderer:
            "hljs" in window ? p: new i.Renderer,
    ...
    function(e, t, n) {
        ...
        function(i) {
            ...
            function f(e, t) {
                ...
                a = h,
                s = g,
                f = l(f, d, h, g, e[n], 7, -680876936),
                g = l(g, f, d, h, e[n + 1], 12, -389564586),
                h = l(h, g, f, d, e[n + 2], 17, 606105819),
                d = l(d, h, g, f, e[n + 3], 22, -1044525330),
                f = l(f, d, h, g, e[n + 4], 7, -176418897),
                g = l(g, f, d, h, e[n + 5], 12, 1200080426),
                h = l(h, g, f, d, e[n + 6], 17, -1473231341),
                d = l(d, h, g, f, e[n + 7], 22, -45705983),
                f = l(f, d, h, g, e[n + 8], 7, 1770035416),
                g = l(g, f, d, h, e[n + 9], 12, -1958414417),
                h = l(h, g, f, d, e[n + 10], 17, -42063),
                d = l(d, h, g, f, e[n + 11], 22, -1990404162),
                f = l(f, d, h, g, e[n + 12], 7, 1804603682),
                g = l(g, f, d, h, e[n + 13], 12, -40341101),
                h = l(h, g, f, d, e[n + 14], 17, -1502002290),
                d = l(d, h, g, f, e[n + 15], 22, 1236535329),
                f = c(f, d, h, g, e[n + 1], 5, -165796510),
                g = c(g, f, d, h, e[n + 6], 9, -1069501632),
                h = c(h, g, f, d, e[n + 11], 14, 643717713),
                d = c(d, h, g, f, e[n], 20, -373897302),
                f = c(f, d, h, g, e[n + 5], 5, -701558691),
                g = c(g, f, d, h, e[n + 10], 9, 38016083),
                h = c(h, g, f, d, e[n + 15], 14, -660478335),
                d = c(d, h, g, f, e[n + 4], 20, -405537848),
                f = c(f, d, h, g, e[n + 9], 5, 568446438),
                g = c(g, f, d, h, e[n + 14], 9, -1019803690),
                h = c(h, g, f, d, e[n + 3], 14, -187363961),
                d = c(d, h, g, f, e[n + 8], 20, 1163531501),
                f = c(f, d, h, g, e[n + 13], 5, -1444681467),
                g = c(g, f, d, h, e[n + 2], 9, -51403784),
                h = c(h, g, f, d, e[n + 7], 14, 1735328473),
                d = c(d, h, g, f, e[n + 12], 20, -1926607734),
                f = u(f, d, h, g, e[n + 5], 4, -378558),
                g = u(g, f, d, h, e[n + 8], 11, -2022574463),
                h = u(h, g, f, d, e[n + 11], 16, 1839030562),
                d = u(d, h, g, f, e[n + 14], 23, -35309556),
                f = u(f, d, h, g, e[n + 1], 4, -1530992060),
                g = u(g, f, d, h, e[n + 4], 11, 1272893353),
                h = u(h, g, f, d, e[n + 7], 16, -155497632),
                d = u(d, h, g, f, e[n + 10], 23, -1094730640),
                f = u(f, d, h, g, e[n + 13], 4, 681279174),
                g = u(g, f, d, h, e[n], 11, -358537222),
                h = u(h, g, f, d, e[n + 3], 16, -722521979),
                d = u(d, h, g, f, e[n + 6], 23, 76029189),
                f = u(f, d, h, g, e[n + 9], 4, -640364487),
                g = u(g, f, d, h, e[n + 12], 11, -421815835),
                h = u(h, g, f, d, e[n + 15], 16, 530742520),
                d = u(d, h, g, f, e[n + 2], 23, -995338651),
                f = p(f, d, h, g, e[n], 6, -198630844),
                g = p(g, f, d, h, e[n + 7], 10, 1126891415),
                h = p(h, g, f, d, e[n + 14], 15, -1416354905),
                d = p(d, h, g, f, e[n + 5], 21, -57434055),
                f = p(f, d, h, g, e[n + 12], 6, 1700485571),
                g = p(g, f, d, h, e[n + 3], 10, -1894986606),
                h = p(h, g, f, d, e[n + 10], 15, -1051523),
                d = p(d, h, g, f, e[n + 1], 21, -2054922799),
                f = p(f, d, h, g, e[n + 8], 6, 1873313359),
                g = p(g, f, d, h, e[n + 15], 10, -30611744),
                h = p(h, g, f, d, e[n + 6], 15, -1560198380),
                d = p(d, h, g, f, e[n + 13], 21, 1309151649),
                f = p(f, d, h, g, e[n + 4], 6, -145523070),
                g = p(g, f, d, h, e[n + 11], 10, -1120210379),
                h = p(h, g, f, d, e[n + 2], 15, 718787259),
                d = p(d, h, g, f, e[n + 9], 21, -343485551),
                f = o(f, r),
                d = o(d, i),
                h = o(h, a),
                g = o(g, s);
            ...
            function y(e, t) {
                ...
                a[n] = 1549556828 ^ i[n];
                return r = f(o.concat(h(t)), 512 + 8 * t.length),
                d(f(a.concat(r), 640))
            }
            function m(e) {
    ...
    function(e, t, n) {
        ...
        c = function(e, t, n) {
            ...
            "[object Array]" === i.call(e) ? a(e, t, o) : "string" == typeof e ? s(e, t, o) : l(e, t, o)
        };
        e.exports = c
    },
    function(e, t, n) {
    ...
    function(e, t, n) { (function(t) { !
            function(t) {
                ...
                n.prototype.token = function(e, t) {
                    ...
                    this.tokens.push({
                        ...
                        for (e = e.substring(i[0].length), o = i[2], f = o.length > 1, this.tokens.push({
                            ...
                            ordered: f,
                            start: f ? +o: ""
                        }), i = i[0].match(this.rules.item), n = !1, p = i.length, c = 0; c < p; c++) s = i[c],
                        l = s.length,
                        s = s.replace(/^ *([*+-]|\d+\.) +/, ""),
                        ~s.indexOf("\n ") && (l -= s.length, s = this.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + l + "}", "gm"), "")),
                        this.options.smartLists && c !== p - 1 && (a = g.bullet.exec(i[c + 1])[0], o === a || o.length > 1 && a.length > 1 || (e = i.slice(c + 1).join("\n") + e, c = p - 1)),
                        r = n || /\n\n(?!\s*$)/.test(s),
                        c !== p - 1 && (n = "\n" === s.charAt(s.length - 1), r || (r = n)),
                        h = /^\[[ xX]\] /.test(s),
                        y = void 0,
                        h && (y = " " !== s[1], s = s.replace(/^\[[ xX]\] +/, "")),
                        this.tokens.push({
                ...
                var y = {
                    escape: /^\\([!"#$%&'()*+,\-./: ; <= >?@\ [\]\\ ^ _` { |
                    }~]) / , autolink: /^<(scheme:[^\s\x00-\x1f<>]*|email)>/, url: p, tag: "^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", link: /^!?\[(label)\]\(href(?:\s+(title))?\s*\)/, reflink: /^!?\[(label)\]\[(?!\s*\])((?:\\[\[\]]?|[^\[\]\\])+)\]/, nolink: /^!?\[(?!\s*\])((?:\[[^\[\]]*\]|\\[\[\]]|[^\[\]])*)\](?:\[\])?/, strong: /^__([^\s][\s\S]*?[^\s])__(?!_)|^\*\*([^\s][\s\S]*?[^\s])\*\*(?!\*)|^__([^\s])__(?!_)|^\*\*([^\s])\*\*(?!\*)/, em: /^_([^\s][\s\S]*?[^\s_])_(?!_)|^_([^\s_][\s\S]*?[^\s])_(?!_)|^\*([^\s][\s\S]*?[^\s*])\*(?!\*)|^\*([^\s*][\s\S]*?[^\s])\*(?!\*)|^_([^\s_])_(?!_)|^\*([^\s*])\*(?!\*)/, code: /^(`+)\s*([\s\S]*?[^`]?)\s*\1(?!`)/, br: /^ {2,}\n(?!\s*$)/, del: p, text: /^[\s\S]+?(?=[\\<!\[`*]|\b_| {2,}\n|$)/
                }; y._escapes = /\\([!"#$%&'()*+,\-./: ; <= >?@\ [\]\\ ^ _` { |
                }~]) / g, y._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, y._email = /[a-zA-Z0-9.!#$%&'*+/ = ?^_` { |
                }~ - ] + (@)[a - zA - Z0 - 9]( ? :[a - zA - Z0 - 9 - ] {
                    0,
                    61
                ...
                r.prototype.smartypants = function(e) {
                    ...
                    var m = {},
                    v = /^$|^[a-z][a-z0-9+.-]*:|^[?#]/i; p.exec = p, h.options = h.setOptions = function(e) {
        ...
        function(e, t, n) {
            ...
            c.prototype.t = function(e, t) {
                ...
                r = e;
                return "string" == typeof n && (r = l(n, i, this.currentLocale, this.tokenRegex, this.pluralRules)),
                r
            },
...
*/
        ...
        function(e, t, n) {
            ...
            function c(e, t) {
                ...
                if (2 === n.length && s(e) && a(t)) for (var o = 0,
                u = e.length; o < u; o++) i = t(e[o], p.get(e[o])),
                c.set(e[o], i);
                return c
            }
